...
func (c ServiceController) FindUsers(ctx context.Context, req core.Request) (*core.Response, error) {
	...
	users, err := c.DataService.FindUsers(ctx, base, nil)
	if err != nil {
		return nil, err
	}
	...
	return &core.Response{
		...
		Body:       dto.GetListResponse{Results: users},
	}, nil
}
